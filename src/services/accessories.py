...
class AccessoriesService:
    def __init__(self, session: AsyncSession) -> None:
        self.accessories_repository: AccessoriesRepository = AccessoriesRepository(session=session)
    ...
    async def update(self, _id: UUID4, accessories: AccessoriesSchemaCRUD) -> None:
        return await self.accessories_repository.update(_id=_id, update_accessories=accessories)
